...
const { loginData,areaData,branchData } = require('../Testdata/Data');
...
describe('Payyap Mobile', () => {
    ...
    it('Create area', async function () {
       ...
       await LoginPage.clickAllowPermission();
        ...
        await AreaPage.createArea(areaData);
        await AreaPage.verifyCreatedArea(areaData);
